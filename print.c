...
printfはリターン - 1を返す printf return -1

					ft_printf

						size_t->int size_t->ssize_t
					...
					桁数分だけmallocする 1234567 /
		1000000->1 1234567 / 100000->12 % 10 1234567 / 10000->123 % 100

		size_t
		ft_putnum_base(unsined long num, char *base)
{
